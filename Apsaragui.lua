if getgenv().Tvk then 
    if game.CoreGui:FindFirstChild("APSARA HUB GUI") then for i, v in ipairs(game.CoreGui:GetChildren()) do if v.Name == "APSARA HUB GUI" then v:Destroy() end end end
end
getgenv().Tvk = true
...
Library_Function.NotiGui.Name = 'Apsara Notification'
...
function Library.CreateNoti(Setting)
    ...
    TextLabelNoti.Text = "<font color=\"rgb(" .. color .. ")\">An ni hut </font> "..getgenv().TitleNameNoti
